      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 p-4">
            ...
            <div id="parentreg">
              <form class="border shadow p-4 m-auto" id="regForm" method="POST" action="in.php">
                <div class="form-group p-2">
                ...
                <div class="tab h4 text-center"> Basic Information
                ...
                <!-- Contact Information -->
                <div class="tab h4 text-center"> Contact Information
                  <div class="form-group p-2">
                ...
                <!-- Account Information -->
                <div class="tab h4 text-center"> Account Information
                  <div class="form-group p-2">
